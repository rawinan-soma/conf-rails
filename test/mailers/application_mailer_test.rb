...
class ApplicationMailerTest < ActionMailer::TestCase
  ...
  test "[P1] default from uses mailers.sender_display i18n key" do
  ...
  test "[P0] default from contains organization name ENVOCC" do
    from_value = ApplicationMailer.default[:from]
    resolved = from_value.respond_to?(:call) ? from_value.call : from_value
  ...
  test "[P1] ApplicationMailer deliver_later uses mailers queue" do
